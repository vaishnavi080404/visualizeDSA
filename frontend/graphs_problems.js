...
const PROBLEMS = [
  {
    ...
    pattern: "BFS",
    realWorld:
      "Used in shortest path discovery in unweighted networks like social graphs (degrees of connection).",
    ...
    examples: [
      {
        ...
        output: "[0,1,2,3,4]",
        explain:
          "Starting from 0, visit 1 and 2, then neighbors of 1 (3) and neighbors of 2 (4).",
      },
    ],
  ...
  },
  {
    ...
    pattern: "DFS",
    realWorld:
      "Used in topological sorting, solving puzzles (mazes), and finding connected components.",
    ...
    examples: [
      { input: "V=5, adj=[[1,2],[0,3],[0,4],[1],[2]]", output: "[0,1,3,2,4]" },
    ],
    constraints: ["1 ≤ V ≤ 10⁴", "0 ≤ E ≤ 2*10⁴"],
  ...
  },
  {
    ...
    realWorld:
      "Used in resource allocation to detect deadlocks in operating systems.",
  ...
  },
  {
    ...
    realWorld:
      "Used in GPS navigation to find the route with the fewest number of turns or stops.",
    ...
    examples: [
      {
        input: "V=4, edges=[[0,1],[0,2],[1,2],[2,3]], src=0",
        output: "[0,1,1,2]",
      },
    ],
    constraints: ["1 ≤ V ≤ 10⁴", "0 ≤ E ≤ 2*10⁴"],
    ...
    starterCode: {
      ...
      javascript:
        "function shortestPath(V, edges, src) {\n    // Your code here\n}",
    },
    solution: {
    ...
    testCases: [
      { input: "4, [[0,1],[0,2],[1,2],[2,3]], 0", expected: "[0,1,1,2]" },
    ],
  ...
  },
  {
    ...
    realWorld:
      "Used in build systems (like Make or Gradle) to determine the order of task execution based on dependencies.",
    ...
    testCases: [
      { input: "6, [[],[],[3],[1],[0,1],[0,2]]", expected: "[5,4,2,3,1,0]" },
    ],
