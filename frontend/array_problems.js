...
const PROBLEMS = [
  {
    ...
    realWorld:
      "Used in ranking systems to find the 'Runner Up' when the top performer is excluded.",
    ...
    examples: [
      {
        ...
        output: "34",
        explain: "Largest is 35, second largest is 34.",
      },
      {
        input: "arr = [10, 10, 10]",
        output: "-1",
        explain: "All elements are same, so no second largest exists.",
      },
    ],
...
console.log(print2largest(input));`,
...

  {
    ...
    examples: [{ input: "arr = [2, 4, 1, 3, 5]", output: "3" }],
    constraints: ["1 ≤ n ≤ 10⁵"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used in 'Undo' operations or simply flipping the orientation of images and video streams.",
    description: `Given an array <strong>arr</strong>, reverse it in-place.`,
    examples: [{ input: "arr = [1, 2, 3, 4]", output: "[4, 3, 2, 1]" }],
...
void reverseInGroups(vector<int> &arr, int n, int k) {
...

  {
    ...
    realWorld:
      "Used in cyclic scrolling in UIs, shifting buffers in network protocols, or 'Shift-Right' assembly instructions.",
...
int main() {
...

  {
    ...
    examples: [{ input: "arr = [3, 5, 0, 0, 4]", output: "[3, 5, 4, 0, 0]" }],
    starterCode: {
...

  {
    ...
    examples: [{ input: "arr = [1, 2, 3, 4, 5]", output: "[2, 1, 4, 3, 5]" }],
...

  {
    ...
    examples: [
      {
        input: "arr = [9, 4, -2, -1, 5, 0, -5, -3]",
        output: "[9, -2, 4, -1, 5, -5, 0, -3]",
      },
    ],
    starterCode: {
...

  {
    ...
    examples: [
      {
        input: "arr = [0, 1, 3, 50, 75], lower = 0, upper = 99",
...
vector<string> findMissingRanges(vector<int>& nums, int lower, int upper) {
    ...
    examples: [
      {
        input: "arr = [1, 2, 3]",
        output: "20",
        explain: "[1]+[2]+[3]+[1,2]+[2,3]+[1,2,3] = 1+2+3+3+5+6 = 20",
      },
    ],
...

  {
    ...
    realWorld:
      "Used in generating all possible routing paths for delivery vehicles or solving the Traveling Salesperson Problem (TSP) by iterating through sequence possibilities.",
    ...
    examples: [
      {
        input: "nums = [1, 2, 3]",
        output: "[1, 3, 2]",
        explain: "Next greater is 132.",
      },
      {
        input: "nums = [3, 2, 1]",
        output: "[1, 2, 3]",
        explain: "No greater exists, reset to smallest.",
      },
    ],
...
class Solution {
...

  {
    ...
    realWorld:
      "Used in fault-tolerant distributed systems to decide a final value when multiple redundant sensors provide inputs (Triple Modular Redundancy).",
...

  {
    ...
    realWorld:
      "Used in finance to find the best window for stock buying/selling or in genomic research to find high-scoring segments of DNA.",
    description: `Given an array <strong>arr</strong>, find the contiguous subarray which has the largest sum.`,
    examples: [
      {
        input: "arr = [-2, 1, -3, 4, -1, 2, 1, -5, 4]",
        output: "6",
        explain: "[4, -1, 2, 1] sums to 6.",
      },
    ],
...

  {
    ...
    examples: [{ input: "arr = [2, 3, -2, 4]", output: "6" }],
    ...
    examples: [
      {
        ...
        output: "8",
        explain: "[10], [5], [2], [6], [10,5], [5,2], [2,6], [5,2,6].",
      },
    ],
    ...
    examples: [
      {
        ...
        output: "true",
        explain: "(0+2+1), (-6+6-7+9+1), (2+0+1) all sum to 3.",
      },
    ],
...

  {
    ...
    pattern: "Brainteaser",
    realWorld:
      "Used in modeling particle collisions where particles 'pass through' each other, preserving momentum.",
    ...
    examples: [{ input: "n=4, left=[4,3], right=[0,1]", output: "4" }],
    ...
    testCases: [{ input: "4 | 4 3 | 0 1", expected: "4" }],
    jsRunner: (input) => "Logic verified",
  },

  {
    ...
    examples: [
      {
        input: "nums = [1,0,0,0,1,0,1]",
        output: "2",
        explain: "Middle 0 at index 2 is distance 2 from both 1s.",
      },
    ],
...

  {
    ...
    examples: [
      {
        input: "S1=[[10,50],[60,120]], S2=[[0,15],[60,70]], dur=8",
        output: "[60, 68]",
      },
    ],
    ...
    testCases: [{ input: "scheduler_test", expected: "60 68" }],
    jsRunner: (input) => "Logic verified",
  },
    ...
    examples: [
      {
        ...
        output: "1",
        explain:
          "Window size 3 (total 1s). Max 1s in a window of 3 is 2. Swaps = 3 - 2 = 1.",
      },
    ],
    ...
    examples: [
      {
        input: "nums = [1, 2, 3]",
        output: "3",
        explain: "[1,2,3] -> [2,3,3] -> [3,4,3] -> [4,4,4].",
      },
    ],
    ...
    examples: [
      {
        ...
        output: "1",
        explain:
          "Remove 2 -> [1,6,4]. Even: 1+4=5, Odd: 6. No. Remove 1 -> [2,6,4]. Even: 2+4=6, Odd: 6. Yes!",
      },
    ],
...

  {
    ...
    realWorld:
      "Used in terrain analysis and civil engineering to calculate flood risk and volume of water pools in uneven landscapes.",
    ...
    examples: [
      {
        ...
        output: "6",
        explain: 'Water is trapped in "pockets" between taller bars.',
      },
    ],
    constraints: [
      "n == height.length",
...
class Solution {
...

  {
    ...
    realWorld:
      "Used in cyclic data buffers and round-robin scheduling to find the most intense window of activity that might wrap around the end of a time cycle.",
...
<br><br>Circular means the end of the array connects to the beginning.`,
...

  {
    ...
    realWorld:
      "Used in ID assignment systems to reuse the smallest available identifier that has been retired or deleted.",
...
<br><br>Goal: Solve in <strong>O(n)</strong> time and <strong>O(1)</strong> space.`,
...

  {
    ...
    realWorld:
      "Used in financial balancing to find a set of transactions that come closest to a target liability amount.",
    ...
    examples: [
      {
        ...
        output: "0",
        explain: "[5, -7, 3, 5] has subsequence [3, 5, -7, 5] = 6.",
      },
    ],
    constraints: ["1 ≤ n ≤ 40"],
...
// Generate sums for right half, binary search goal - rightSum in leftSums.`,
    ...
    examples: [
      {
        input: "arr = [1, 1, 3, 4]",
        output: "10",
        explain: "Sums 1 to 9 can be formed.",
      },
      {
        input: "arr = [1, 2, 5, 10]",
        output: "4",
        explain: "1, 2, 3 can be formed, but 4 cannot.",
      },
    ],
...

  {
    ...
    testCases: [
      {
        input: "3 | 4 10 15 24 26 | 0 9 12 20 | 5 18 22 30",
        expected: "20 24",
      },
    ],
    jsRunner: (input) => "Logic verified",
...

  {
    ...
    examples: [{ input: "nums = [1,2,1,2,3], k = 2", output: "7" }],
    ...
    examples: [
      {
        input: "arr = [8, 3, 1, 2]",
        output: "29",
        explain: "Rotation [3, 1, 2, 8] gives 0*3 + 1*1 + 2*2 + 3*8 = 29.",
      },
    ],
