...
document.getElementById("l2").addEventListener("click", () => {
  if (localStorage.getItem(L2_KEY) === "true") {
    window.location.href = "hashing_l2.html";
    return;
  }
  modalMsg.textContent =
    "Pass the Level 1 Quiz to unlock Level 2 and continue your Hashing journey.";
  modal.style.display = "flex";
  startQuizBtn.onclick = () =>
    (window.location.href = "quiz.html?id=hashing-l1");
});
document.getElementById("l3").addEventListener("click", () => {
  ...
  if (!l2) {
    modalMsg.textContent = "Complete Level 1 first before accessing Level 3.";
  } else {
