...
const PROBLEMS = [
  {
    ...
    realWorld:
      "Used in computer graphics to sort polygons by their depth (Painter's Algorithm) when the number of objects is very small and nearly sorted.",
    ...
    examples: [
      {
        ...
        output: "[1, 2, 4, 5, 8]",
        explain:
          "5 and 1 swap, then 5 and 4 swap, then 5 and 2 swap. After pass 1, 8 is at the end.",
      },
    ],
...
if (input.length > 0) {
...

  {
    ...
    realWorld:
      "Used to verify if a list is already sorted with minimal effort. In a best-case scenario (already sorted), this reduces time complexity to O(n).",
    ...
    examples: [
      {
        input: "arr = [1, 2, 3, 4, 5]",
        output: "Sorted in 1 pass",
        explain: "No swaps needed, exit early.",
      },
    ],
...
int main() {
...

  {
    ...
    realWorld:
      "Used when you need to sort items from 'Highest to Lowest' like ranking participants by their scores.",
    description: `Implement Bubble Sort to sort an array in <strong>descending order</strong> (Largest to Smallest).`,
    examples: [{ input: "arr = [1, 5, 2, 8]", output: "[8, 5, 2, 1]" }],
    constraints: ["1 ≤ n ≤ 1000"],
...
int main() {
...

  {
    ...
    realWorld:
      "Counting swaps is a way to measure the 'inversion count' or how much 'disorder' is in a list.",
    ...
    examples: [
      {
        input: "arr = [3, 2, 1]",
        output: "3",
        explain: "Swap (3,2), then (3,1), then (2,1). Total = 3.",
      },
    ],
    constraints: ["1 ≤ n ≤ 1000"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used to sort names alphabetically in simple embedded systems without complex sorting libraries.",
    ...
    constraints: ["1 ≤ n ≤ 500", "String length ≤ 50"],
...
int main() {
...

  {
    ...
    pattern: "Recursion",
    realWorld:
      "Demonstrates how iterative algorithms can be translated into recursive function calls, a common concept in functional programming.",
...
<br><br>The base case should be when the array size is 1. Each recursive step should perform one "bubble" pass to move the maximum element to the end.`,
    examples: [{ input: "arr = [3, 1, 2]", output: "[1, 2, 3]" }],
    constraints: ["1 ≤ n ≤ 500"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used in data packet prioritization where you want to group certain types of data (like control packets vs data packets) while maintaining relative order within groups.",
    ...
    examples: [
      {
        input: "arr = [1, 2, 3, 4]",
        output: "[2, 4, 1, 3] (or any order where even comes first)",
      },
    ],
    constraints: ["1 ≤ n ≤ 1000"],
...
int main() {
...

  {
    ...
    pattern: "Adaptive Search",
    realWorld:
      "Used in systems where data is frequently 'nearly sorted' (like real-time data feeds), allowing the system to skip unnecessary processing cycles.",
    ...
    examples: [
      {
        input: "arr = [1, 2, 3, 4, 5]",
        output: "1",
        explain: "No swaps in the first pass, so it exits immediately.",
      },
      {
        input: "arr = [2, 1, 3, 4, 5]",
        output: "2",
        explain: "Swaps 2 and 1 in pass 1. Pass 2 finds no swaps and exits.",
      },
    ],
    constraints: ["1 ≤ n ≤ 1000", "-10⁴ ≤ arr[i] ≤ 10⁴"],
...
console.log(optimizedBubbleSort(arr, n));`,
...

  {
    ...
    pattern: "Recursion",
    realWorld:
      "Used to understand how iterative loops can be converted into recursive calls, a common concept in functional programming languages.",
...
if __name__ == "__main__":
...

  {
    ...
    realWorld:
      "Used in financial software to sort a list of transactions containing both credits (positives) and debits (negatives).",
...
int main() {
...

  {
    ...
    pattern: "Lexicographical Sort",
    realWorld:
      "Sorting names in a contact list or words in a dictionary in simple database systems.",
...
console.log(arr.join(' '));`,
...

  {
    ...
    realWorld:
      "Used in search engines to sort only the first 'page' (Top K) of results while keeping the rest unsorted.",
    ...
    examples: [
      {
        ...
        output: "[3, 4, 5, 2, 1]",
        explain: "Only indices 0, 1, 2 are sorted.",
      },
    ],
...
int main() {
...

  {
    ...
    realWorld:
      "Used for educational visualizations to track which element is currently 'bubbling' to the top of the unsorted segment.",
    ...
    examples: [
      {
        input: "arr = [5, 1, 4, 2, 8]",
        output: "[8, 5, 4, 2]",
        explain: "Pass 1 moves 8 to end. Pass 2 moves 5 to index 3, etc.",
      },
    ],
    constraints: ["1 ≤ n ≤ 100"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used as a 'Gatekeeper' function in pipelines to skip heavy sorting algorithms if the incoming data stream is already ordered.",
    ...
    examples: [
      {
        input: "arr = [1, 2, 3, 5, 4]",
        output: "false",
        explain: "Pair (5, 4) is in wrong order.",
      },
...
console.log(isSorted(arr, n));`,
...

  {
    ...
    realWorld:
      "Sorting data in low-level systems (like firmware) where memory is allocated as discrete nodes rather than contiguous blocks.",
    ...
    constraints: ["Number of nodes ≤ 500"],
...
function bubbleSortLL(head) {
...

  {
    ...
    realWorld:
      "Used to separate three types of logs (Error, Warning, Info) based on their severity codes.",
...
<br><br>While faster algorithms exist, this exercise ensures you can apply bubble sorting to specific restricted values.`,
    examples: [{ input: "arr = [2, 0, 1]", output: "[0, 1, 2]" }],
    constraints: ["1 ≤ n ≤ 10⁴"],
...
int main() {
...

  {
    ...
    realWorld:
      "Crucial when sorting entries in a spreadsheet based on one column but needing to know which row each value originally belonged to.",
    ...
    examples: [
      {
        input: "arr = [50, 10, 40]",
        output: "[1, 2, 0]",
        explain: "Sorted is [10, 40, 50]. 10 was at index 1, 40 at 2, 50 at 0.",
      },
    ],
    constraints: ["1 ≤ n ≤ 1000"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used in algorithms where 'turtles' (small values near the end of a list) slow down standard Bubble Sort. Bidirectional passes move them faster.",
...
<br><br>Return the total number of swaps.`,
    examples: [{ input: "arr = [5, 1, 4, 2]", output: "4" }],
    constraints: ["1 ≤ n ≤ 1000"],
...
int main() {
...

  {
    ...
    realWorld:
      "Used in database indexing where writing data (swapping) to disk is 100x slower than reading (comparing) data.",
    ...
    examples: [
      {
        ...
        output: "4",
        explain:
          'The smallest element 1 is a "turtle" and takes 4 passes to move to the front.',
      },
    ],
    constraints: ["1 ≤ n ≤ 1000"],
