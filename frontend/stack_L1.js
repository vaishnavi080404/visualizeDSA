...
function pushElement() {
  ...
  newElement.textContent = stackCount++;
...
function popElement() {
  ...
  if (container.children.length > 0) {
    ...
    setTimeout(() => container.removeChild(lastElement), 300);
  }
}

function resetStack() {
  const container = document.getElementById("stackContainer");
  container.innerHTML = `<div class="stack-element">10</div><div class="stack-element">20</div><div class="stack-element">30</div>`;
  stackCount = 40;
}
